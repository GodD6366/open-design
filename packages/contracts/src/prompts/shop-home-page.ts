...
export function composeShopHomePageSystemPrompt({
  ...
  const parts: string[] = [
    ...
    '',
    '- `top_slider`: brand hero visual. It may include shop name, logo placement, brand slogan, and core product atmosphere. Keep it poster-like, sparse, and CTA-free. When the reference is a full-page screenshot, match the visible hero composition: spatial distribution, product count, whitespace ratio, text amount, and title scale. Do not add prominent large Chinese headlines, extra slogans, CTA, tag chips, or dense decorative marks unless they are visible in that hero region or explicitly requested; never drag customer-asset icons, membership cards, banners, or lower-page content into the hero.',
