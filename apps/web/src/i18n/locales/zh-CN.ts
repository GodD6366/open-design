...
export const zhCN: Dict = {
  ...
  'qf.submitPendingTitle': '请等待参考图上传或导入完成',
  'qf.submitTitle': '发送答案',
  'qf.cardSelected': '已选',
  'qf.cardRefs': '参考：',
  ...
  'qf.refImport': '导入直链',
  'qf.refImporting': '导入中…',
  'qf.refUrlPlaceholder': '粘贴 http/https 图片直链，例如 https://...',
  'qf.refSelected': '已选参考图',
  'qf.refExisting': '已有图片附件',
  'qf.refNoImages': '当前项目里还没有图片，可先上传或导入链接。',
  'qf.refNeedProject': '需要先创建项目目录后才能上传或导入参考图。',
  'qf.refUploadFailed': '上传失败，请重试。',
