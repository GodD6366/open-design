...
export const en: Dict = {
  ...
  'newproj.tabStorefront': 'Storefront home',
  ...
  'newproj.titleStorefront': 'New storefront home',
  ...
  'qf.submitPendingTitle': 'Wait for reference images to finish uploading or importing',
  'qf.submitTitle': 'Send answers',
  'qf.cardSelected': 'selected',
  'qf.cardRefs': 'Refs:',
  'qf.cardSampleText': 'The quick brown fox · 0123',
  'qf.refUpload': 'Upload references',
  'qf.refUploading': 'Uploading…',
  'qf.refImport': 'Import URL',
  'qf.refImporting': 'Importing…',
  'qf.refUrlPlaceholder': 'Paste an http/https direct image URL, e.g. https://...',
  'qf.refSelected': 'Selected references',
  'qf.refExisting': 'Existing project images',
  'qf.refNoImages': 'No project images yet. Upload one or import a URL first.',
  'qf.refNeedProject': 'A project folder is required before importing reference images.',
  'qf.refUploadFailed': 'Upload failed. Please try again.',
