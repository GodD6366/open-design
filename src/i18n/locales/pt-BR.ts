...
export const ptBR: Dict = {
  ...
  'newproj.tabStorefront': 'Vitrine da loja',
  ...
  'newproj.titleStorefront': 'Nova vitrine da loja',
  ...
  'qf.submitPendingTitle': 'Aguarde as imagens de referência terminarem de enviar ou importar',
  'qf.submitTitle': 'Enviar respostas',
  'qf.cardSelected': 'selecionado',
  'qf.cardRefs': 'Refs:',
  'qf.cardSampleText': 'A rápida raposa marrom · 0123',
  'qf.refUpload': 'Enviar referências',
  'qf.refUploading': 'Enviando…',
  'qf.refImport': 'Importar URL',
  'qf.refImporting': 'Importando…',
  'qf.refUrlPlaceholder': 'Cole uma URL direta de imagem http/https, ex.: https://...',
  'qf.refSelected': 'Referências selecionadas',
  'qf.refExisting': 'Imagens existentes do projeto',
  'qf.refNoImages': 'Ainda não há imagens no projeto. Envie uma ou importe uma URL primeiro.',
  'qf.refNeedProject': 'É preciso ter uma pasta de projeto antes de importar imagens de referência.',
  'qf.refUploadFailed': 'Falha no envio. Tente novamente.',
