export const STOREFRONT_PHONE_CHROME = {
  deviceWidth: 390,
  deviceHeight: 844,
...
export const STOREFRONT_STATUS_SIGNAL_BARS = [
...
export const STOREFRONT_STATUS_WIFI_PATHS = [
...
export const STOREFRONT_STATUS_BATTERY = {
  viewBox: '0 0 25 11',
