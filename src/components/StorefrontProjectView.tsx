...
import STOREFRONT_TONE_PRESETS from '../storefront/tone-presets.json';
...
import { composeStorefrontSystemPrompt } from '../prompts/storefront';
import {
  createConversation,
...
const STOREFRONT_TONE_LABELS: Record<string, string> = Object.fromEntries(
  (STOREFRONT_TONE_PRESETS as Array<{ id: string; label: string }>).map((preset) => [
    preset.id,
    preset.label,
  ]),
);
